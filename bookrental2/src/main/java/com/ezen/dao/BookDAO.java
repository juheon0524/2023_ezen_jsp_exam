...
public class BookDAO {
	...
	public int bookSearchCount(String sWord) {
	    String sql = "select count(*) as bookcount from " +
                "(select * from book " +
                " where author like ? " +
                " or title like ? " +
                " or publisher like ? " +
	...
	public List<BookVO> selectAllBooksBySword(int start, int end, String sWord) {
		List<BookVO> bookList = new ArrayList<BookVO>();
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
