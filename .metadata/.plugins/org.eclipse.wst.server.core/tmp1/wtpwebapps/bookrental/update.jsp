					...
					<input type="hidden" name="command" value="update_success">
                        <table>
                            ...
                            <tr>
                                <th>우편번호</th>
                                <td>
                                    <input type="text" id="postalcode" name="postalcode" value = "${loginUser.postalcode}" readonly="readonly">
                                    <input class="joinBtn" type="button" value="검색" id="btn" >
                                </td>
                            </tr>
                            <tr>
                                <th>주소</th>
                                <td>
                                    <input type="text" id="postaladdress" name="postaladdress" value = "${loginUser.postaladdress}" readonly="readonly" >
                                </td>
                            </tr>
                            <tr>
                                <th>상세주소</th>
