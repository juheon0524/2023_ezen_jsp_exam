					...
					<input type="hidden" name="command" value="join_success">
                        <table>
                            ...
                            <tr>
                                <th>우편번호</th>
                                <td>
                                    <input type="text"  name="postalcode" maxlength="5" readonly="readonly">
                                    <input class="joinBtn" type="button" value="번호검색" id="btn">
                                </td>
                            </tr>
                            <tr>
                                <th >주소</th>
                                <td>
                                    <input type="text"   name="postaladdress"  readonly="readonly"><br>
                                </td>
                            </tr>
                            <tr>
                                <th>상세주소</th>
                            ...
                            <tr>
                                <th>생년월일</th>
                                <td>
                                    <input type="text"  name="birthdate" placeholder="예시:'1998-05-05'">
                                </td>
                            </tr>
                            <tr>
                                <th>비밀번호</th>
...
function idCheck() {
	...
	let url = "BookServlet?command=idcheck&memberid=" + document.getElementsByName("memberid")[0].value;
