        ...
        <div class="shareContentWrap">
            ...
            <div class="shareContentBox">
                ...
                <div class="shareContent">
                    ...
                    <form class="joinAgreeForm" action="join.jsp" onsubmit="return validateAgreements();">
                        <div>
...
(효 력) 본 약관은 이용자가 회원에 가입함과 동시에 효력을 발생합니다.
                            ...
                            <div class="joinAgreeCheckBox">
                                ...
                                <input type="checkbox" id="agree1" onclick="">
                            </div>
                        </div>
...
3.민원사무 처리 : 민원처리 종료 후 3년
                            ...
                            <div class="joinAgreeCheckBox">
                                ...
                                <input type="checkbox" id="agree2" onclick="">
                            </div>
                        </div>
...
5.제공시기 : 정보주체의 책이음서비스 요청시 (정보변경 시)
                            ...
                            <div class="joinAgreeCheckBox">
                                ...
                                <input type="checkbox"  id="agree3" onclick="">
                            </div>
                        </div>
